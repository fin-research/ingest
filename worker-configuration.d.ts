/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e8d76decb6567461a2e037d4983c8f06)
// Runtime types generated with workerd@1.20260825.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	ARTICLE_BUCKET: R2Bucket;
	DB: D1Database;
	ARTICLE_API_BASE_URL: "https://eastmoney.hasbai.xyz/data";
	...
	OMO_WORKFLOW: Workflow<Parameters<import("./src/index").OmoWorkflow['run']>[0]['payload']>;
	OPEN_MARKET_WORKFLOW: Workflow<Parameters<import("./src/index").OpenMarketWorkflow['run']>[0]['payload']>;
	ARCHIVE_CLEANUP_WORKFLOW: Workflow<Parameters<import("./src/index").ArchiveCleanupWorkflow['run']>[0]['payload']>;
	ARTICLE_WORKFLOW: Workflow<Parameters<import("./src/index").ArticleWorkflow['run']>[0]['payload']>;
	TELEGRAM_WORKFLOW: Workflow<Parameters<import("./src/index").TelegramWorkflow['run']>[0]['payload']>;
	POLICY_WORKFLOW: Workflow<Parameters<import("./src/index").PolicyWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARTICLE_API_BASE_URL" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_ID" | "CF_AIG_TOKEN">> {}
}
