/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 19c8e182cea73a3630667fcb813db9fb)
...
interface __BaseEnv_Env {
	...
	TELEGRAM_USER_ID: SecretsStoreSecret;
	RESEARCH_SEARCH: AiSearchInstance;
	FINANCE_SEARCH: AiSearchInstance;
	...
	ARCHIVE_MIGRATION_WORKFLOW: Workflow<Parameters<import("./src/index").ArticleArchiveMigrationWorkflow['run']>[0]['payload']>;
}
